...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('🔧 Register Debug - Form data:', { username, email, password: '***' });

    try {
      console.log('🔧 Register Debug - Calling register function...');
      ...
      console.log('🔧 Register Debug - Setting error message:', errorMessage);
